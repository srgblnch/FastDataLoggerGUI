...
#
# Created: Fri Oct 24 16:38:19 2014
...
class Ui_FastDataLoggerDLLRF(object):
    def setupUi(self, FastDataLoggerDLLRF):
        ...
        self.BeamCurrentValue = QtGui.QDoubleSpinBox(self.frame)
        self.BeamCurrentValue.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.BeamCurrentValue.setObjectName(_fromUtf8("BeamCurrentValue"))
        self.gridLayout_9.addWidget(self.BeamCurrentValue, 2, 1, 1, 1)
        self.DiagFileValue = QtGui.QLineEdit(self.frame)
        self.DiagFileValue.setObjectName(_fromUtf8("DiagFileValue"))
        self.gridLayout_9.addWidget(self.DiagFileValue, 1, 1, 1, 1)
        self.LoopsFileValue = QtGui.QLineEdit(self.frame)
        self.LoopsFileValue.setMinimumSize(QtCore.QSize(0, 0))
        self.LoopsFileValue.setObjectName(_fromUtf8("LoopsFileValue"))
        self.gridLayout_9.addWidget(self.LoopsFileValue, 0, 1, 1, 1)
        self.CurrentLabel = QtGui.QLabel(self.frame)
        self.CurrentLabel.setObjectName(_fromUtf8("CurrentLabel"))
        self.gridLayout_9.addWidget(self.CurrentLabel, 2, 0, 1, 1)
        self.DiagFileLabel = QtGui.QLabel(self.frame)
        self.DiagFileLabel.setObjectName(_fromUtf8("DiagFileLabel"))
        self.gridLayout_9.addWidget(self.DiagFileLabel, 1, 0, 1, 1)
        self.LoopsFileLabel = QtGui.QLabel(self.frame)
        self.LoopsFileLabel.setObjectName(_fromUtf8("LoopsFileLabel"))
        self.gridLayout_9.addWidget(self.LoopsFileLabel, 0, 0, 1, 1)
        ...
        self.loops1ScrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 756, 812))
        ...
        self.loops2ScrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 756, 812))
    ...
    def retranslateUi(self, FastDataLoggerDLLRF):
        ...
        self.CurrentLabel.setText(QtGui.QApplication.translate("FastDataLoggerDLLRF", "Current", None, QtGui.QApplication.UnicodeUTF8))
        self.DiagFileLabel.setText(QtGui.QApplication.translate("FastDataLoggerDLLRF", "Diagnostics", None, QtGui.QApplication.UnicodeUTF8))
        self.LoopsFileLabel.setText(QtGui.QApplication.translate("FastDataLoggerDLLRF", "Loops", None, QtGui.QApplication.UnicodeUTF8))
